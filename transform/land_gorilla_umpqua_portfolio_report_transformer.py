...
class LandGorillaUmpquaPortfolioReportTransformer(Transformer):
    ...
    def transform_data(self)-> None:
        ...
        columns_to_clean = [
            'Loan Number', 'Borrower', 'Property Address', 'State',
            'Total Units', 'Funding Account', 'Investor', 'Current Loan Amount', 'Loan Amount Disbursed', 'Appraised Value',
            'Calculated LTV', 'Loan Funded Date', 'Current Loan Due Date', 'Loan Program'
        ]

        string_columns = [
            'Loan Number', 'Borrower', 'Property Address', 'State', 'Total Units',
            'Funding Account', 'Investor', 'Loan Program'
        ]

        datetime_columns = [
            'Loan Funded Date', 'Current Loan Due Date'
        ]

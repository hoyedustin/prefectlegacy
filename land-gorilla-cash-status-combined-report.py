...
from transform.land_gorilla_cash_status_combined_transformer import LandGorillaCashStatusCombinedTransformer

@task
def transform_data(df):
    transformer = LandGorillaCashStatusCombinedTransformer(df)
...
def get_dynamic_filename():
  ...
  dynamic_filename = f"land_gorilla_cash_status_{today_date}.csv"
...
def land_gorilla_cash_status_combined_report() -> None:
    ...
    print(df.columns)
    print(df['Collateral Holdback'])
  
  

    print(df_transformed.head())
    print(df_transformed['collateral_holdback'])

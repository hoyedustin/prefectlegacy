...
def get_dynamic_filename():
  ...
  dynamic_filename = f"land_gorilla_maturity_dates_report_{today_date}.csv"
...
#    loader = LandGorillaMaturityDateLoader(snowflake_username, snowflake_account, snowflake_database, 
...
#    temp = transformed_most_recent_maturity_dates_report
#    export_file(temp)
...
def land_gorilla_maturity_dates_report() -> None:
    ...
    folder = "land-gorilla-maturity-dates-report"
